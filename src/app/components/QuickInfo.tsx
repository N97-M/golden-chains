...
export default function QuickInfo() {
  return (
    <section className="relative py-16 text-white">
      ...
      >
        {/* Dark Overlay */}
        <div className="absolute inset-0 bg-[#1a1f2e] bg-opacity-90"></div>
      </div>
          ...
          <div className="flex-1 grid grid-cols-1 md:grid-cols-4 gap-8 md:pr-4">
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-300">Pho: +971 525128817</p>
                <p className="text-gray-300">Mob: +971 525128817</p>
                <p className="text-gray-300">WApp: +971 525128817</p>
              </div>
            </div>
