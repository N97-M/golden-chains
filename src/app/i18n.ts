  ...
  en: {
    translation: {
      ...
      brands: {
        ...
        nextAutoCvJoint: "High-quality CV Joints",
      ...
      nextAutoCvJointPage: {
        title: "NEXT AUTO CV JOINT",
        description: "Premium quality CV Joints designed for reliability and long-lasting performance.",
        outer: "Outer CV Joint",
        inner: "Inner CV Joint",
        outerDesc: "High-quality Outer CV Joint for superior performance and durability.",
        innerDesc: "Precision-engineered Inner CV Joint ensuring smooth power transmission.",
      },
    },
  },
  ar: {
    translation: {
      ...
      brands: {
        ...
        nextAutoCvJoint: "مفاصل سرعة ثابتة (CV Joints) عالية الجودة",
      ...
      nextAutoCvJointPage: {
        title: "نيكست أوتو - مفاصل السرعة الثابتة",
        description: "مفاصل سرعة ثابتة (CV Joints) عالية الجودة مصممة للموثوقية والأداء طويل الأمد.",
        outer: "مفصل خارجي (Outer CV Joint)",
        inner: "مفصل داخلي (Inner CV Joint)",
        outerDesc: "مفصل خارجي عالي الجودة لأداء متفوق ومتانة.",
        innerDesc: "مفصل داخلي مصمم بدقة لضمان نقل سلس للطاقة.",
      },
    },
  },
};
